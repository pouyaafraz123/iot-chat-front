            ...
            <form onSubmit={handleSubmit} noValidate className="row justify-content-center">
                <div className="col-lg-6 col-md-6 col-12">
                    <Input label={"Channel Name"}
                           ...
                           value={inputs.channelName} handleChange={handleChange} status={status.channelName} required/>
                </div>
                <div className="col-lg-6 col-md-6 col-12">
                    <Input label={"Channel Description"}
                           placeHolder={"Enter your Channel Description ..."}
                           name={"description"} id={"description"} type={"text"}
                           value={inputs.description} handleChange={handleChange} status={status.description} required/>
                </div>
                <div className="col-lg-6 col-md-6 col-12">
                    <Input label={"Channel Display Name"}
                           ...
                           value={inputs.displayName} handleChange={handleChange} status={status.displayName} required/>
                </div>
                <div className="col-lg-6 col-md-6 col-12">
